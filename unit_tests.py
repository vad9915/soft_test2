...
class TestFormulas(unittest.TestCase):
    ...
    def test_first_calculation1(self):
        F = Formulas(1)
        res = F.calculation_1()
        self.assertEqual(res, 3.6720000000000006)
    ...
    def test_second_calculation1(self):
        F = Formulas(0.1)
        res = F.calculation_1()
        self.assertEqual(res, 0.3439341)
    ...
    def test_fifth_calculation1(self):
        F = Formulas(-200)
        res = F.calculation_1()
        self.assertEqual(res, 2974888549.8)
    ...
    def test_sixth_calculation1(self):
        F = Formulas(1000)
        res = F.calculation_1()
        self.assertEqual(res, 1873312636851.0)
    ...
    def test_seventh_calculation1(self):
        F = Formulas(199)
        res = F.calculation_1()
        self.assertEqual(res, 2952262721.736)
    ...
    def test_eighth_calculation1(self):
        F = Formulas(192)
        res = F.calculation_1()
        self.assertEqual(res, 2558843082.816)
    ...
    def test_ninth_calculation1(self):
        F = Formulas(200)
        res = F.calculation_1()
        self.assertEqual(res, 3011962090.2)
    ...
    def test_tenth_calculation1(self):
        F = Formulas(300)
        res = F.calculation_1()
        self.assertEqual(res, 15217267125.3)
